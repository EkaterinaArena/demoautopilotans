		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Suppliers",
									"targetURL": "#demobusinesspartners-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demobusinesspartners-display": {
								"semanticObject": "demobusinesspartners",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.businesspartners",
									"url": sap.ui.require.toUrl("demo/businesspartners")
								}
							}
						}
					}
